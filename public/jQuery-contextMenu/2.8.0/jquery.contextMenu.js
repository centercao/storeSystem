...
(function (factory) {
    ...
    var // currently active contextMenu trigger
        ...
        defaults = {
            ...
            classNames: {
                hover: 'context-menu-hover ui-state-active', // Item hover
                disabled: 'context-menu-disabled ui-state-disabled', // Item disabled
        ...
        op = {
            ...
            create: function (opt, root) {
                ...
                // create contextMenu
                opt.$menu = $('<ul class="context-menu-list  ui-widget-content"></ul>').addClass(opt.className || '').data({
                    'contextMenu': opt,
                ...
                $.each(opt.items, function (key, item) {
                    var $t = $('<li class="context-menu-item ui-menu-item"></li>').addClass(item.className || ''),
                        $label = null,
                        $input = null;
